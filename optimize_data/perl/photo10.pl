...
# total pilot per flag high penalty function, where Z is the number of pilots
my $PENALTY_TOTAL_PILOT_GT_30 = 10;	# max {0, Y-30} * $PENALTY_TOTAL_PILOT_GT_30
my $PENALTY_TOTAL_PILOT_GT_40 = 100;	# max {0, Y-40} * $PENALTY_TOTAL_PILOT_GT_40
########################################################
...
sub gen_LP {
	...
	# for current FLAG, penalty for total pilot
	{
		my $first_time = 1;
		foreach my $E (keys %EQPID_def) {
			if ($first_time == 0) {
		...
		print FLP " - TOTAL_PILOT = 0;\n";

		# total_pilot30 = max {0, total_pilot-30}
		print FLP "TOTAL_PILOT_GT_30 >= 0;\n";
		print FLP "TOTAL_PILOT_GT_30 - TOTAL_PILOT >= - 30;\n";
		# total_pilot40 = max {0, total_pilot-40}
		print FLP "TOTAL_PILOT_GT_40 >= 0;\n";
		print FLP "TOTAL_PILOT_GT_40 - TOTAL_PILOT >= - 40;\n";
	}
	...
	print FLP "- WEIGHT";
	foreach my $E (keys %EQPID_def) {
		print FLP " + $PENALTY_TOTAL_PILOT_GT_30 TOTAL_PILOT_GT_30";
		print FLP " + $PENALTY_TOTAL_PILOT_GT_40 TOTAL_PILOT_GT_40";
